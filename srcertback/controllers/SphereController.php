...
class SphereController extends BaseController
{
    ...
    *    tags={"Sphere"},
    *    path="/sphere",
    *    summary="list spheres",
    *    description="find sphere",
    *     @OA\Parameter(
    ...
    *        @OA\JsonContent(
    *            type="array",
    *            @OA\Items(ref="#/components/schemas/Sphere")
    *         )
    *    ),
    ...
    */
	...
	$q = Sphere::find()->andWhere(['account_id' => self::$user->account_id]);
	$q->orderBy('id asc');
	...
	if ($query) {
            $q->andWhere('lower(spherename) like :q', ['q' => $query ]);
        }
        $cnt = $q->count();
    ...
    *    description="create new sphere",
    *    @OA\RequestBody(
    *        @OA\MediaType(
    *            mediaType="application/json",
    *            @OA\Schema(ref="#/components/schemas/Sphere")
    *          )
    *     ),
    *    @OA\Response(
    *        response=200,
    *        description="OK",
    *        @OA\JsonContent(ref="#/components/schemas/Sphere")
    *    ),
    *    security={{"api_key":{"PHPSESSID"}}}
    * )
    */
    public function actionCreate()
    {
	    ...
	    self::createLog('sphere', serialize($model));
    ...
    *    description="delete  sphere",
    *     tags={"Sphere"},
    *     @OA\Parameter(
    *         description="Sphere id to delete",
    *         in="query",
    *         name="id",
    *         required=true,
    *         @OA\Schema(
...
/**
    * @OA\Get(
    *     path="/sphere/restore",
    *     summary="Restore sphere",
    *    description="restore  sphere",
    *     tags={"Sphere"},
    *     @OA\Parameter(
    *         description="Sphere id to delete",
    *         in="query",
    ...
    */
    public function actionUpdate()
    {
		...
		return self::error('Model deleted ');
            ...
            $model->spherename = $modelNew->spherename; 
            if ($model->save()) {
                self::updateLog('sphere', $id);
                return self::ok($model);
            }
        return self::error($model->getErrors());
    }
    ...
    public function actionDownloadlist()
    {
		...
		return Excel::export([
            ...
            'fileName' => $table,
            'models' => $resarr,
            'columns' => ['id', 'spherename', 'account_id', 'deleted_at', ],
            'headers' => ['id'  => 'id', 'spherename'  => 'spherename', 'account_id'  => 'account_id', 'deleted_at'  => 'deleted_at', ],
        ]);
    }
	...
	private function issetParams(array $array){
		$this->error = [];
		$nameArr = ['id', 'spherename', 'account_id', 'deleted_at', ];
