...
class CityController extends BaseController
{
    ...
    */
    ...
    {
	$q = City::find()->andWhere(['account_id' => self::$user->account_id]);
	$q->orderBy('name asc');  
    ...
    */
	...
	self::createLog('city', serialize($model));
    ...
    */
    public function actionDelete()
	{
		...
		if (!$model) {
			self::error('City not found with id: ' . $id);
			return;
		}
				if ($model->deleted_at) {
