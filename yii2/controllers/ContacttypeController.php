...
class ContacttypeController extends BaseController
{
    ...
    *    tags={"Contacttype"},
    *    path="/contacttype",
    *    summary="list contacttypes",
    *    description="find contacttype",
    *     @OA\Parameter(
    ...
    *        @OA\JsonContent(
    *            type="array",
    *            @OA\Items(ref="#/components/schemas/Contacttype")
    *         )
    *    ),
    ...
    */
    public function actionIndex()
    {
	    ...
	    $q = Contacttype::find()->andWhere(['account_id' => self::$user->account_id]);
	    $q->orderBy('id asc');
    ...
    * @OA\Post(
    *    tags={"Contacttype"},
    *    path="/contacttype/create",
    *    summary="create  contacttype ",
    *    description="create new contacttype",
    *    @OA\RequestBody(
    *        @OA\MediaType(
    *            mediaType="application/json",
    *            @OA\Schema(ref="#/components/schemas/Contacttype")
    *          )
    *     ),
    *    @OA\Response(
    *        response=200,
    *        description="OK",
    *        @OA\JsonContent(ref="#/components/schemas/Contacttype")
    *    ),
    *    security={{"api_key":{"PHPSESSID"}}}
    * )
    */
	...
	self::createLog('contacttype', serialize($model));
        return self::ok($model);
    }

    /**
    * @OA\Delete(
    *     path="/contacttype/delete",
    *     summary="Delete contacttype",
    *    description="delete  contacttype",
    *     tags={"Contacttype"},
    *     @OA\Parameter(
    *         description="Contacttype id to delete",
    *         in="query",
    *         name="id",
    *         required=true,
    *         @OA\Schema(
    ...
    */
    public function actionDelete()
	{
		...
		if (!$model) {
			self::error('Contacttype not found with id: ' . $id);
			return;
		}
				if ($model->deleted_at) {
...
/**
    * @OA\Get(
    *     path="/contacttype/restore",
    *     summary="Restore contacttype",
    *    description="restore  contacttype",
    *     tags={"Contacttype"},
    *     @OA\Parameter(
    *         description="Contacttype id to delete",
    *         in="query",
    ...
    */
    public function actionRestore()
	{
		...
		if ($model->update()()) {
			self::restoreLog('contacttype', $id);
			return self::ok();
		} else {
		    self::error($model->getErrors());
		}
    ...
    * @OA\Post(
    *    tags={"Contacttype"},
    *    path="/contacttype/update",
    *    summary="update  contacttype ",
    ...
    private function updateRecord($v){
        ...
        if ($v != null && is_array($v)) {
            ...
            if ($isset == self::RES_TRUE) {
                $model = Contacttype::findOne($v['id']);
                if ($model == null) {
                    $model = new Contacttype();
                }
				if($v['id']){
